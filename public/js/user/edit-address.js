...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const validationRules = {
    ...
    landMark: {
      ...
      message: 'Landmark must be 6-100 characters long, containing letters, numbers, commas, hyphens, or spaces, with at least 2 unique alphanumeric characters. Avoid consecutive spaces, commas, or hyphens.'
    },
    pincode: {
      pattern: /^\d{6}$/,
